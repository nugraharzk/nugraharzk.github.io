...
const Portfolio: React.FC = () => {
  const professionalSummaryRef = useRef<HTMLElement>(null);
  const technicalSkillsRef = useRef<HTMLElement>(null);
  const professionalExperienceRef = useRef<HTMLElement>(null);
