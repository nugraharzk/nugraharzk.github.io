...
const App = () => {
  return (
    <div className="bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 h-screen flex flex-col justify-center items-center">
      <div className="bg-white mx-auto p-8 rounded-lg shadow-2xl w-screen md:w-1/2 lg:w-1/3 transform transition duration-500 hover:scale-105">
        ...
        <div className="text-center text-gray-600 p-2">
          ...
          <a href="https://twitter.com/rizkinug__" target="_blank" rel="noopener noreferrer" className="bg-blue-500 text-white px-4 py-2 rounded-full shadow-md hover:bg-blue-600 transition duration-300 ml-2">
